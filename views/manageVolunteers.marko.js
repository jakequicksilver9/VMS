...
function render(input, out, __component, component, state) {
  ...
  out.w("<!DOCTYPE html><html xmlns:th=http://www.thymeleaf.org lang=en><head><title>Manage Volunteers</title><link rel=stylesheet type=text/css href=/js/datatables.min.css><link rel=stylesheet type=text/css href=/js/bootstrap.min.css><script type=text/javascript src=/js/jquery.min.js></script><script type=text/javascript src=/js/datatables.min.js></script><script type=text/javascript src=/js/bootstrap.min.js></script><script>" +
    ...
    "</h1><h1>Volunteers to manage</h1><div class=\"row justify-content-center\"><div class=col-8><table id=table><thead><th>id</th><th>first name</th><th>last name</th><th>user name</th><th data-orderable=false>delete</th><th data-orderable=false>edit</th></thead><tbody id=tableBody></tbody></table><input type=button value=\"Add Volunteer\" id=addVolunteer><input type=button value=Manage id=manage><input type=button value=\"log out\" id=logOut></div></div>");
