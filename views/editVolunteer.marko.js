...
function render(input, out, __component, component, state) {
  ...
  out.w("<!DOCTYPE html><html xmlns:th=http://www.thymeleaf.org lang=en><head><title>Edit Volunteers</title><script src=/js/jquery.js></script><script src=/js/js/bootstrap.js></script><link rel=stylesheet src=/js/css/bootstrap.css><script>" +
    ...
    " method=post name=editVolunteer><label for=first>First name: </label><input type=text id=first name=firstname" +
    marko_attr("value", input.volunteer.firstname) +
    "><br><br><label for=last>Last name: </label><input type=text id=last name=lastname" +
    marko_attr("value", input.volunteer.lastname) +
    "><br><br><label for=userName>User name: </label><input type=text id=userName name=username" +
    ...
    "><br><br><label for>Perfered Volunteer centers: </label><textarea rows=3 cols=40 name=centers id" +
    marko_attr("value", input.volunteer.centers) +
    "></textarea><br><br><label for>Skills/Interests: </label><textarea rows=3 cols=40 name=skills id" +
    marko_attr("value", input.volunteer.skills) +
    "></textarea><br><br><label for>Availability Times: </label><input type=text id name=availability" +
    marko_attr("value", input.volunteer.availability) +
    "><br><br><label for>Address: </label><input type=text id=address name=address placeholder=\"house# street zip state\"" +
    marko_attr("value", input.volunteer.address) +
    "><br><br><label for>Phone #: </label><input type=text id=phoneNumber name=phone placeholder=##########" +
    marko_attr("value", input.volunteer.phone) +
    "><br><br><label for=email>Email: </label><input type=text id=email name=email placeholder=example@exaple.com" +
    marko_attr("value", input.volunteer.email) +
    "><br><br><label for=educationalBackground>Edcuational Background: </label><textarea rows=3 cols=40 name=education id=educationalBackground" +
    marko_attr("value", input.volunteer.education) +
    "></textarea><br><br><label for>Current Licenses: </label><input type=text id name=licenses" +
    marko_attr("value", input.volunteer.licenses) +
    "><br><br><label for>Emergency Contact Name: </label><input type=text id name=emergencyname" +
    marko_attr("value", input.volunteer.emergencyname) +
    "><br><br><label for>Emergency Contact Phone #: </label><input type=text id=emergencyPhoneNumber name=emergencyphone placeholder=##########" +
    marko_attr("value", input.volunteer.emergencyphone) +
    "><br><br><div class=form-group><div class=row><label for>Emergency Contact Email: </label><input type=text id=emergencyEmail name=emergencyemail placeholder=example@exaple.com" +
    marko_attr("value", input.volunteer.emergencyemail) +
    "><br><br></div></div><div class=form-group><div class=row><label for>Emergency Contact Address: </label><input type=text id=emergencyAddress name=emergencyaddress placeholder=\"house# street zip state\"" +
    marko_attr("value", input.volunteer.emergencyaddress) +
    "><br><br></div></div> <div class=form-group><div class=row><label>Copy of Drivers License on File: </label><select class=form-control name=dlfile" +
    marko_attr("value", input.volunteer.dlfile) +
    "><option value=true>True</option><option value=false>False</option></select></div></div><div class=form-group><div class=row><label>Copy of SSN on file: </label><select class=form-control name=ssfile" +
    marko_attr("value", input.volunteer.ssfile) +
    "><option value=true>True</option><option value=false>False</option></select></div></div><div class=form-group><div class=row><label>Volunteers Approval Status: </label><select class=form-control name=approval" +
    marko_attr("value", input.volunteer.approval) +
    "><option value=true>Approved</option><option value=false>Denied</option></select></div></div><div class=form-group><div class=row><input type=submit id=submit value=Submit></div></div></form><input type=button value=Cancel id=cancel><input type=button value=\"log out\" id=logOut onclick(\"logOut\")>");
